...
def get_chord_from_fingers(fs):
    """손가락 패턴을 코드(3개 음)로 변환"""
    chord_map = {
        (False, False, False, False, False): ["C4", "E4", "G4"],      # C major
        (False, True, False, False, False): ["D4", "F#4", "A4"],      # D major
        (False, True, True, False, False): ["E4", "G#4", "B4"],       # E major
        (False, True, True, True, False): ["F4", "A4", "C5"],         # F major
        (True, False, False, False, False): ["G4", "B4", "D4"],       # G major
        (True, True, False, False, False): ["A4", "C#4", "E4"],       # A major
        (True, True, True, False, False): ["B4", "D#4", "F#4"],       # B major
    }
    return chord_map.get(tuple(fs), None)
